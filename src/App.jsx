...
const desc =
  "Learn How to Quickly Generate Placeholder Text Using a Lorem Ipsum Tool. Explore How Lorem Ipsum Generators Can Liven up Your Web Layout Wireframes and Mockups. 100+ Templates. A/B Testing & Surveys.";
      ...
      <nav className="bg-gradient-to-r from-rose-500 via-slate-800 to-slate-900 text-white bg-white h-[60px] fixed top-0 left-0 w-full flex justify-between items-center px-8">
        ...
        <div className="flex gap-5 items-center">
          ...
          <button
            ...
            className="focus:shadow-lg hover:scale-105 transition-translate duration-300 items-center text-sm py-2 px-3 rounded bg-gradient-to-tr from-blue-600 via-blue-500 to-blue-600 text-white flex gap-1 font-medium"
          >
            ...
            <div className="flex flex-col gap-8">
              {highestTasks.length === 0 && (
                <>
                  ...
                  <button
                    onClick={() => setOpen(true)}
                    className="w-fit mx-auto focus:shadow-lg hover:scale-105 transition-translate duration-300 items-center text-sm py-2 px-3 rounded bg-gradient-to-tr from-blue-600 via-blue-500 to-blue-600 text-white flex gap-1 font-medium"
                  >
                    <Plus className="w-4 h-4" />
                    Add task
                  </button>
